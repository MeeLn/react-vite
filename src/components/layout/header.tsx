...
export default function Header() {
  ...
  return (
    <header className=" bg-background text-secondary">
      ...
      <div
        className={`fixed inset-y-0 right-0 h-full w-60 bg-gray-700 p-6 transition-transform duration-300 md:hidden z-50 flex flex-col gap-4
      ...
      >
        ...
        <div className="flex flex-col space-y-4 items-end mr-8">
          <a
            href="#hero"
            onClick={() => setSideBar(false)}
            className="closer hover:border-green-500 hover:border-b-2 hover:text-green-500 focus:text-green-500 focus:border-green-500 focus:border-b-2 text-lg"
          >
            Home
          </a>
          <a
