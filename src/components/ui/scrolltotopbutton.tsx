...
const [visible, setVisible] = useState(false);
    ...
    return (
        <>
            {visible && (
                <button onClick={scrollToTop} className="fixed lg:bottom-6 lg:right-6 bottom-16 right-6 bg-primary text-white border-2 border-primary px-4 py-3 rounded-full hover:bg-muted hover:text-primary transition">
